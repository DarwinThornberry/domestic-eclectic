...
import { LayoutDashboard, Package, Image, Settings, BarChart2, LogOut, ChevronDown } from 'lucide-react'
...
export function AdminShell({ children, userInitials, userName }: Props) {
